<template>
  <div id="carouselExampleControls" class="carousel slide main-slider slider" data-ride="carousel">
    <div class="carousel-inner">
      <swiper class="swiper" :modules="modules" :options="swiperOption" :pagination="{ clickable: true }" :scrollbar="{ draggable: true }">
        <swiper-slide>
          <div class="slider-item carousel-item active" style="background-image:url('src/assets/images/main01.jpg')">
            <div class="container">
              <div class="row">
                <div class="col-lg-6 col-12 offset-lg-6 offset-md-6">
                <div class="slider-caption">
                  <span class="lead">미리보는 챔피온 </span>
                  <h1 class="mt-2 mb-5"><span class="text-color">22FW </span>신상품 할인 혜택</h1>
        ...
        <swiper-slide>
          <div class="slider-item carousel-item active" style="background-image:url('src/assets/images/main02.jpg')">
            <div class="container">
              <div class="row">
                <div class="col-lg-6 col-12 offset-lg-6 offset-md-6">
                <div class="slider-caption">
        ...
        <swiper-slide>
          <div class="slider-item carousel-item active" style="background-image:url('src/assets/images/main03.jpg')">
            <div class="container">
              <div class="row">
                <div class="col-lg-6 col-12 offset-lg-6 offset-md-6">
                <div class="slider-caption">
        ...
        <swiper-slide>
          <div class="slider-item carousel-item active" style="background-image:url('src/assets/images/main04.jpg')">
            <div class="container">
              <div class="row">
                <div class="col-lg-6 col-12 offset-lg-6 offset-md-6">
                <div class="slider-caption">
